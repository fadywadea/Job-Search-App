...
import { addJobVal, deleteJobVal, getAllJobsWithCompanyInfoVal, getJobsByCompanyNameVal, jobsFilterVal, updateJobVal } from "./job.validation.js";
import { validation } from "../../middleware/validation.js";
import { addJob, deleteJob, getAllJobsWithCompanyInfo, getJobsByCompanyName, jobsFilter, updateJob } from "./job.controller.js";
...
jobRouter.route("/filter")
  .get(protectedRoutes, authorization('User', 'Company_HR'), validation(jobsFilterVal), jobsFilter) // Get all Jobs that match the following filters
